...
class UpdatePlanPlacePic extends StatefulWidget {
  Function uploadCallBack;
  UpdatePlanPlacePic({this.uploadCallBack});
  @override
  _UpdatePlanPlacePic createState() => _UpdatePlanPlacePic();
}
...
class _UpdatePlanPlacePic extends State<UpdatePlanPlacePic>
  ...
  _uploadImages(GlobalPostProvider globalPostProvider) async {
    ...
    Fluttertoast.showToast(
        ...
        textColor: Colors.white,
        fontSize: 16.0);
    widget.uploadCallBack(urls);
    /*  await FirebaseFirestore.instance
        .collection("users")
        .doc(auth.currentUser.uid)
        .collection("plans")
        .doc(auth.currentUser.uid)
        .set({'planplacepic': urls}, SetOptions(merge: true)).then((_) {
      print("pic uploded");
    });*/
  }
}
