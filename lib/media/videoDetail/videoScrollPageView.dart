...
class VideoScrollPageController extends ScrollController {
  VideoScrollPageController({
    this.initialPage = 0,
    this.keepPage = true,
...
final VideoScrollPageController _defaultPageController = VideoScrollPageController();
...
class VideoScrollPageView extends StatefulWidget {
  VideoScrollPageView({
    ...
    this.reverse = false,
    VideoScrollPageController controller,
    this.physics,
  ...
  final VideoScrollPageController controller;
...
class _VideoScrollPageViewState extends State<VideoScrollPageView> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<VideoScrollPageController>(
        'controller', widget.controller,
        showName: false));
