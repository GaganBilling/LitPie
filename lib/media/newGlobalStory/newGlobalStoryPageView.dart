...
class NewGlobalStoryPageController extends ScrollController {
  NewGlobalStoryPageController({
    this.initialPage = 0,
    this.keepPage = true,
...
final NewGlobalStoryPageController _defaultPageController = NewGlobalStoryPageController();
const PageScrollPhysics _kPagePhysics = PageScrollPhysics();

class VideoScrollPageView extends StatefulWidget {
  VideoScrollPageView({
    Key key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    NewGlobalStoryPageController controller,
    this.physics,
  ...
  final NewGlobalStoryPageController controller;
  ...
  @override
  _VideoScrollPageViewState createState() => _VideoScrollPageViewState();
}

class _VideoScrollPageViewState extends State<VideoScrollPageView> {
  ...
  Widget build(BuildContext context) {
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: Scrollable(
        ...
        //     ScrollConfiguration.of(context).copyWith(scrollbars: false), //changed (commented)
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<NewGlobalStoryPageController>(
        'controller', widget.controller,
        showName: false));
