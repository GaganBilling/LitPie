...
class StoryMediaPageController extends ScrollController {
  StoryMediaPageController({
    this.initialPage = 0,
    this.keepPage = true,
...
final StoryMediaPageController _defaultPageController = StoryMediaPageController();
...
class VideoScrollPageView extends StatefulWidget {
  VideoScrollPageView({
    ...
    this.reverse = false,
    StoryMediaPageController controller,
    this.physics,
  ...
  final StoryMediaPageController controller;
...
class _VideoScrollPageViewState extends State<VideoScrollPageView> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<StoryMediaPageController>(
        'controller', widget.controller,
        showName: false));
