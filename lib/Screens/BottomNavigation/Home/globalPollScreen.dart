...
class _GlobalPollScreenState extends State<GlobalPollScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print("globalPostProvider.isPostLoading - ");
    print(globalPostProvider.isPostLoading);
              ...
              : (globalPostProvider.posts.isEmpty
                  ...
                  : (globalPostProvider.posts.length == 0
                      ...
                      : SmartRefresher(
                          ...
                          onRefresh: () async {
                            print("Sm 1");
                            await globalPostProvider.getDataFromDatabaseForListing();
                          ...
                          onLoading: () async {
                            print("Sm load 1");
                            print("loading..");
                            await globalPostProvider.updateFeedList();
                            await Future.delayed(Duration(milliseconds: 1000));
                            if (mounted)
                              setState(() {
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: StreamBuilder(
                                              stream: globalPostProvider
                                                  .firebaseController
                                                  .userColReference
                                                  .doc(globalPostProvider.posts[index]
                                                  .createdBy)
                                                  .get()
                                                  .asStream(),
                                              builder: (context,
                                        ...
                                        MyPollWidget(
                                          ...
                                          deletePollPressed:
                                              () async {
                                            if (globalPostProvider.posts[index]
                                                .pollQuestion
                                                .createdBy ==
                                                globalPostProvider
                                                    .firebaseController
                                                    ...
                                                    Container(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            Utils().convertToAgoAndDate(globalPostProvider.posts[index]
                                                                .createdAt),
                                                            style: TextStyle(
                                                                color: themeProvider.isDarkMode
                                                                    ? Colors.white
                                                  ...
                                                  StreamBuilder(
                                                      stream: globalPostProvider
                                                          ...
                                                          globalPostProvider
                                                              ...
                                                              .uid)
                                                          .where("postId",
                                                          isEqualTo: globalPostProvider.posts[
                                                          index]
                                                              .postId)
                                                          .limit(1)
                                                          .snapshots()
                                                        ...
                                                        if (snapshot
                                                          ...
                                                          return GestureDetector(
                                                            ...
                                                            onTap:
                                                              ...
                                                              QuerySnapshot
                                                              isLiked =
                                                              await globalPostProvider.getLikeButton(globalPostProvider.posts[index]
                                                                  .postId);
                                                              if (isLiked
                                                                  .docs
                                                                  .isEmpty) {
